...
For 3+ raters on a continuous variable, use ***Intraclass Correlation***. See [this page](https://www.rdocumentation.org/packages/psych/versions/2.2.3/topics/ICC] for a function to calculate this).
